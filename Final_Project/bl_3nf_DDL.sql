...
create table if not exists bl_3nf.ce_bookings (
    ...
    booking_src_id    varchar(50)      not null,
    source_system     varchar(255)      not null,
    source_entity     varchar(255)      not null,
    update_dt         timestamp         not null,
    insert_dt         timestamp         not null
...
--DROP TABLE bl_3nf.customers_scd;
...
drop table bl_3nf.ce_rates cascade;
...
create table if not exists bl_3nf.ce_vendor_addresses (
    ...
    vendor_address_src_id  varchar(50)      not null,
    source_system          varchar(255)      not null,
    source_entity          varchar(255)      not null,
    update_dt              timestamp         not null,
    insert_dt              timestamp         not null
...
create table if not exists bl_3nf.ce_locations (
    ...
    location_src_id  varchar(50)   not null,                            --POPRAVKA na varchar !!!
    source_system    varchar(255)   not null,
    source_entity    varchar(255)   not null,
    update_dt        timestamp      not null,
    insert_dt        timestamp      not null
...
create table if not exists bl_3nf.ce_vendors (
    ...
    vendor_src_id     varchar(50)      not null,  -- source_id
    source_system     varchar(255)      not null,
    source_entity     varchar(255)      not null,
    update_dt         timestamp         not null,
    insert_dt         timestamp         not null,
