...
CREATE INDEX IF NOT EXISTS idx_cust_active 
ON bl_3nf.ce_customers_scd (customer_src_id, customer_type, customer_telephone, is_active);
...
(
    ...
    '2017-06-15 09:30:00.000 +0200',      -- pickup_datetime
    '2017-06-15 09:45:00.000 +0200',      -- dropoff_datetime
    3,                                  -- passenger_count
    ...
    'cash',                             -- payment_type
    '2017-06-15 09:50:00.000 +0200',      -- payment_datetime
...
SET
    ...
    pickup_datetime      = '2016-05-26 13:48:00.000 +0300',
    dropoff_datetime     = '2016-05-26 13:55:00.000 +0300',
    passenger_count      = 2,
    ...
    booking_type         = 'online',
    booking_datetime     = '2016-05-26 13:46:00.000 +0300',
