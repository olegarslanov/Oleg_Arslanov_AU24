...
create extension if not exists file_fdw with schema sa_green_taxi;
...
-- create add for working with external files
create extension if not exists file_fdw with schema sa_yellow_taxi;
...
truncate table bl_cl.combined_taxi_data;
