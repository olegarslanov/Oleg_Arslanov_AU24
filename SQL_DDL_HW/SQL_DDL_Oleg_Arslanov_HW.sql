...
--Create all tables without constrains
...
-- Create all constraints for all tables
...
if not exists (
	...
	where 
		table_name = 'club'
		and constraint_name = 'pk_club'
) 
then 
execute 'alter table training_data.club
...
if not exists (
	...
	where 
		table_name = 'climb'
		and constraint_name = 'pk_climb'
) 
then 
execute 'alter table training_data.climb
add constraint pk_climb primary key(climb_id)';
end if;
end $$;
...
if not exists (
	...
	where 
		table_name = 'location'
		and constraint_name = 'pk_location'
) 
then 
execute 'alter table training_data.location
...
if not exists (
	...
	where 
		...
		and constraint_name = 'pk_equipment'
) 
then 
execute 'alter table training_data.equipment
...
if not exists (
	...
	where 
		table_name = 'sponsor'
		and constraint_name = 'pk_sponsor_sponsor'
) then
execute 'alter table training_data.sponsor
add constraint pk_sponsor_sponsor primary key (sponsor_id)';
end if;
end $$;
...
if not exists (
	...
	where 
		table_name = 'address'
		and constraint_name = 'pk_address'
) then 
execute 'alter table training_data.address
...
if not exists (
	...
	where 
		table_name = 'climber'
		and constraint_name = 'pk_climber'
) then
execute 'alter table training_data.climber
add constraint pk_climber primary key(climber_id)';
end if;
end $$;
...
if not exists (
	...
	where 
		table_name = 'climber'
		and constraint_name = 'fk_climber_address'
) then
execute 'alter table training_data.climber
add constraint fk_climber_address foreign key(address_id) references training_data.address (address_id)';
end if;
end $$;
...
if not exists (
	...
	where 
		table_name = 'weather'
		and constraint_name = 'pk_weather'
) 
then 
execute 'alter table training_data.weather
add constraint pk_weather primary key(weather_id)';
end if;
end $$;
...
if not exists (
	...
	where 
		table_name = 'weather'
		and constraint_name = 'fk_weather_climb'
) 
then 
execute 'alter table training_data.weather
add constraint fk_weather_climb foreign key(climb_id) references training_data.climb (climb_id)';
end if;
end $$;
...
if not exists (
	...
	where 
		table_name = 'mountain'
		and constraint_name = 'pk_mountain'
) 
then 
execute 'alter table training_data.mountain
add constraint pk_mountain primary key(mountain_id)';
end if;
end $$;
...
if not exists (
	...
	where 
		table_name = 'mountain'
		and constraint_name = 'fk_location'
) 
then 
execute 'alter table training_data.mountain
add constraint fk_location foreign key(location_id) references training_data.location (location_id)';
end if;
end $$;
...
if not exists (
	...
	where
		table_name = 'donation'
		and constraint_name = 'pk_donation'
) then
execute 'alter table training_data.donation
...
if not exists (
	...
	where
		table_name = 'donation'
		and constraint_name = 'fk_donation_club'
) then
execute 'alter table training_data.donation
add constraint fk_donation_club foreign key (club_id) REFERENCES training_data.club(club_id)';
end if;
end $$;
...
if not exists (
	...
	where
		table_name = 'donation'
		and constraint_name = 'fk_donation_sponsor'
) then
execute 'alter table training_data.donation
add constraint fk_donation_sponsor foreign key(sponsor_id) references training_data.sponsor (sponsor_id)';
end if;
end $$;
...
if not exists (
	...
	where
		table_name = 'donation'
		and constraint_name = 'fk_donation_climber'
) then
execute 'alter table training_data.donation
add constraint fk_donation_climber foreign key(climber_id) references training_data.climber (climber_id)';
end if;
end $$;
...
if not exists (
	...
	where 
		...
		and constraint_name = 'pk_climber_equipment'
) 
then 
execute 'alter table training_data.climber_equipment
add constraint pk_climber_equipment primary key(climber_id, equipment_id)';
end if;
end $$;
...
if not exists (
	...
	where 
		table_name = 'climber_equipment'
		and constraint_name = 'fk_climber_equipment_climber'
) 
then 
execute 'alter table training_data.climber_equipment
add constraint fk_climber_equipment_climber foreign key(climber_id) references training_data.climber (climber_id)';
end if;
end $$;
...
if not exists (
	...
	where 
		table_name = 'climber_equipment'
		and constraint_name = 'fk_climber_equipment_equipment'
) 
then 
execute 'alter table training_data.climber_equipment
add constraint fk_climber_equipment_equipment foreign key(equipment_id) references training_data.equipment (equipment_id)';
end if;
end $$;
...
if not exists (
	...
	where 
		...
		and constraint_name = 'fk_climber_climb_climber'
) 
then 
execute 'alter table training_data.climber_climb
add constraint fk_climber_climb_climber foreign key(climber_id) references training_data.climber (climber_id)';
end if;
end $$;
...
if not exists (
	...
	where 
		table_name = 'climber_climb'
		and constraint_name = 'fk_climber_climb_climb'
) 
then 
execute 'alter table training_data.climber_climb
add constraint fk_climber_climb_climb foreign key(climb_id) references training_data.climb (climb_id)';
end if;
end $$;
...
if not exists (
	...
	where 
		table_name = 'climber_climb'
		and constraint_name = 'fk_climber_climb_club'
) 
then 
execute 'alter table training_data.climber_climb
add constraint fk_climber_climb_club foreign key(club_id) references training_data.club (club_id)';
end if;
end $$;
...
if not exists (
	...
	where 
		table_name = 'climber_climb'
		and constraint_name = 'pk_climber_climb'
) 
then 
execute 'alter table training_data.climber_climb
add constraint pk_climber_climb primary key(climber_id, climb_id, club_id)';
end if;
end $$;
...
if not exists (
	...
	where 
		table_name = 'route'
		and constraint_name = 'pk_route'
) 
then 
execute 'alter table training_data.route
...
if not exists (
	...
	where 
		table_name = 'route'
		and constraint_name = 'fk_route_mountain'
) 
then 
execute 'alter table training_data.route
add constraint fk_route_mountain foreign key(mountain_id) references training_data.mountain (mountain_id)';
end if;
end $$;
...
if not exists (
	...
	where 
		...
		and constraint_name = 'pk_climb_route'
) 
then 
execute 'alter table training_data.climb_route
add constraint pk_climb_route primary key(route_id, climb_id, club_id)';
end if;
end $$;
...
if not exists (
	...
	where 
		table_name = 'climb_route'
		and constraint_name = 'fk_climb_route_route'
) 
then 
execute 'alter table training_data.climb_route
add constraint fk_climb_route_route foreign key(route_id) references training_data.route (route_id)';
end if;
end $$;
...
if not exists (
	...
	where 
		table_name = 'climb_route'
		and constraint_name = 'fk_climb_route_climb'
) 
then 
execute 'alter table training_data.climb_route
add constraint fk_climb_route_climb foreign key(climb_id) references training_data.climb (climb_id)';
end if;
end $$;
...
if not exists (
	...
	where 
		table_name = 'climb_route'
		and constraint_name = 'fk_climb_route_club'
) 
then 
execute 'alter table training_data.climb_route
add constraint fk_climb_route_club foreign key(club_id) references training_data.club (club_id)';
end if;
end $$;
...
if not exists (
	...
	where 
		...
		and constraint_name = 'fk_climb_schedule'
) 
then 
execute 'alter table training_data.climb_schedule
add constraint fk_climb_schedule foreign key(climb_id) references training_data.climb (climb_id)';
end if;
end $$;

--
--Added additional HW constraints 
...
add constraint check_date2 check (date(recorded_on) > '2000-01-01');
end if;
end $$;
...
--if not exists (
	...
	--where 
		--table_name = 'donation'
		--and constraint_name = 'check_unique3'
--) 
--then 
--alter table training_data.donation
--add constraint check_unique3 unique (club_id, sponsor_id, climber_id);
--end if;
--end $$;

--alter table training_data.donation
--drop constraint check_unique3 
...
--1
with club_data as (
	select 1 as club_id, 'Climbs In Seconds' as name, 'Poland' as location, '+375174551789' as telephone_number, 'climbinseconds@gmail.com' as email, 'Mountain climbing club focused on promoting outdoor/indoor adventures and fostering a community of climbers. The club organizes various climbing events and training sessions while seeking sponsorship to support both individual climbers and overall club activities.' as description
	union all
	select 2 as club_id, 'x' as name, 'Lithuania' as location, '+37066171780' as telephone_number, 'x@gmail.com' as email, 'information about club' as description
)
insert into training_data.club (club_id, name, location, telephone_number, email, description)
select club_id, name, location, telephone_number, email, description
...
with address_data as (
	select 100 as address_id, 'Lithuania' as country, 'Vilnius' as city, 'Tuskulenu' as street, '41' as house_number, 4 as flat_number
	union all
	select 200 as address_id, 'Poland' as country, 'Krakow' as city, 'Krakowska' as street, '4a' as house_number, null as flat_number
)
insert into training_data.address (address_id, country, city, street, house_number, flat_number)
select address_id, country, city, street, house_number, flat_number
...
with weather_data as (
	select climb_id, 18.5 as temperature, 5.2 as wind_speed, false as precipation, current_timestamp as recorded_on
	from training_data.climb
	where upper(name) = upper('Zakopane Morske Oko')
	union all
	select climb_id, 7.0 as temperature, 6.3 as wind_speed, true as precipation, current_timestamp as recorded_on
	from training_data.climb
	where upper(name) = upper('Alpine Challenge')
)
insert into training_data.weather (climb_id, temperature, wind_speed, precipation, recorded_on)
select climb_id, temperature, wind_speed, precipation, recorded_on
...
--3
--I dont know how better fill donation table ... 
...
update training_data.address set record_ts = current_date
where record_ts is null;
update training_data.climb set record_ts = current_date
where record_ts is null;
update training_data.climb_route set record_ts = current_date
where record_ts is null;
update training_data.climb_schedule set record_ts = current_date
where record_ts is null;
update training_data.climber set record_ts = current_date
where record_ts is null;
update training_data.climber_climb set record_ts = current_date
where record_ts is null;
update training_data.climber_equipment set record_ts = current_date
where record_ts is null;
update training_data.club set record_ts = current_date
where record_ts is null;
update training_data.donation set record_ts = current_date
where record_ts is null;
update training_data.equipment set record_ts = current_date
where record_ts is null;
update training_data.location set record_ts = current_date
where record_ts is null;
update training_data.mountain set record_ts = current_date
where record_ts is null;
update training_data.route set record_ts = current_date
where record_ts is null;
update training_data.sponsor set record_ts = current_date
where record_ts is null;
update training_data.weather set record_ts = current_date
where record_ts is null;
